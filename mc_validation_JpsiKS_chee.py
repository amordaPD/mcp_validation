...
with open('mc9_1111540100.txt', 'r') as f_mc9:
    content = f_mc9.readlines()
    content = content[3:-2]
    for x in content:
        row = x.split("*")
        if(float(row[6])>5.250):
            nPXD_Jpsi_e0_mc9.append(float(row[2]))
            nPXD_Jpsi_e1_mc9.append(float(row[3]))
            nSVD_Jpsi_e0_mc9.append(float(row[4]))
            nSVD_Jpsi_e1_mc9.append(float(row[5]))    
            ...
            Jpsi_e0_TrPval_mc9.append(float(row[18]))
            Jpsi_e1_TrPval_mc9.append(float(row[19]))
            ...
            nCDC_Jpsi_e0_mc9.append(float(row[28]))  
            nCDC_Jpsi_e1_mc9.append(float(row[29]))  
...
with open('mc8_1111540100.txt', 'r') as f_mc8:
    content = f_mc8.readlines()
    content = content[3:-2]
    for x in content:
        row = x.split("*")
        if(float(row[6])>5.250):
            nPXD_Jpsi_e0_mc8.append(float(row[2]))
            nPXD_Jpsi_e1_mc8.append(float(row[3]))
            nSVD_Jpsi_e0_mc8.append(float(row[4]))
            nSVD_Jpsi_e1_mc8.append(float(row[5]))    
            ...
            Jpsi_e0_TrPval_mc8.append(float(row[18]))
            Jpsi_e1_TrPval_mc8.append(float(row[19]))
            ...
            nCDC_Jpsi_e0_mc8.append(float(row[28]))  
            nCDC_Jpsi_e1_mc8.append(float(row[29]))  
...
d_inner_mc8 = {'e0 PXD': nPXD_Jpsi_e0_mc8,'e1 PXD': nPXD_Jpsi_e1_mc8, 'e0 SVD': nSVD_Jpsi_e0_mc8,'e1 SVD': nSVD_Jpsi_e1_mc8}
...
d_inner_mc9 = {'pi0 PXD': nPXD_Jpsi_e0_mc9,'pi1 PXD': nPXD_Jpsi_e1_mc9, 'pi0 SVD': nSVD_Jpsi_e0_mc9,'pi1 SVD': nSVD_Jpsi_e1_mc9}
...
axs_inner[0, 0].hist(nPXD_Jpsi_e0_mc8,5,range=[0,5], normed=True,alpha=0.7)
axs_inner[0, 0].hist(nPXD_Jpsi_e0_mc9,5,range=[0,5], normed=True,alpha=0.7)
axs_inner[0, 0].set_xlabel('nPXD e0')
axs_inner[0, 0].set_ylabel('A.U.')

axs_inner[0, 1].hist(nSVD_Jpsi_e0_mc8,12,range=[0,12], normed=True,alpha=0.7)
axs_inner[0, 1].hist(nSVD_Jpsi_e0_mc9,12,range=[0,12], normed=True,alpha=0.7)
axs_inner[0, 1].set_xlabel('nSVD e0')
axs_inner[0, 1].set_ylabel('A.U.')

axs_inner[0, 2].hist(nCDC_Jpsi_e0_mc8,80,range=[0,80], normed=True,alpha=0.7)
axs_inner[0, 2].hist(nCDC_Jpsi_e0_mc9,80,range=[0,80], normed=True,alpha=0.7)
axs_inner[0, 2].set_xlabel('nCDC e0')
axs_inner[0, 2].set_ylabel('A.U.')

axs_inner[0, 3].hist(Jpsi_e0_TrPval_mc8,200,range=[0,1], normed=True,alpha=0.7)
axs_inner[0, 3].hist(Jpsi_e0_TrPval_mc9,200,range=[0,1], normed=True,alpha=0.7)
axs_inner[0, 3].set_xlabel('e0 TrPval')
axs_inner[0, 3].set_ylabel('A.U.')
axs_inner[0, 3].set_yscale('log')

axs_inner[1, 0].hist(nPXD_Jpsi_e1_mc8,5,range=[0,5], normed=True,alpha=0.7)
axs_inner[1, 0].hist(nPXD_Jpsi_e1_mc9,5,range=[0,5], normed=True,alpha=0.7)
axs_inner[1, 0].set_xlabel('nPXD e1')
axs_inner[1, 0].set_ylabel('A.U.')


axs_inner[1, 1].hist(nSVD_Jpsi_e1_mc8,12,range=[0,12], normed=True,alpha=0.7)
axs_inner[1, 1].hist(nSVD_Jpsi_e1_mc9,12,range=[0,12], normed=True,alpha=0.7)
axs_inner[1, 1].set_xlabel('nSVD e1')
axs_inner[1, 1].set_ylabel('A.U.')


axs_inner[1, 2].hist(nCDC_Jpsi_e1_mc8,80,range=[0,80], normed=True,alpha=0.7)
axs_inner[1, 2].hist(nCDC_Jpsi_e1_mc9,80,range=[0,80], normed=True,alpha=0.7)
axs_inner[1, 2].set_xlabel('nCDC e1')
axs_inner[1, 2].set_ylabel('A.U.')

axs_inner[1, 3].hist(Jpsi_e1_TrPval_mc8,200,range=[0,1], normed=True,alpha=0.7)
axs_inner[1, 3].hist(Jpsi_e1_TrPval_mc9,200,range=[0,1], normed=True,alpha=0.7)
axs_inner[1, 3].set_xlabel('e1 TrPval')
